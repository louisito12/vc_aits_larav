...
return [
    ...
    */
    ...
    'connections' => [
        ...
        'ict_ticketing' => [
            'driver' => 'sqlsrv',
            'host' => env('DB_HOST_Ticket', '192.170.11.58'),
            'port' => env('DB_PORT_Ticket', '1433'),
            'database' => env('DB_DATABASE_Ticket', 'another_database'),
            'username' => env('DB_USERNAME_Ticket', 'another_user'),
            'password' => env('DB_PASSWORD_Ticket', 'another_password'),
            'charset' => 'utf8',
            'prefix' => '',
        ],
