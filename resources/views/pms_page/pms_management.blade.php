            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <di class="col-6">
                            <label>Noted By</label>
                            <select id="edit_noted_by" class="form-control spec_input"></select>
                        </di>
                        <div class="col-6">
                            <label>Conducted By</label>
                            <input id="edit_conducted_by" type="text" class="form-control spec_input">
                        </div>
                    </div>
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#add_pms_save').click(function () {
                ...
                const noted_by = $('#noted_by').val();
                const conducted_by = $('#conducted_by').val();
                ...
                $.ajax({
                    ...
                    success: function (e) {
                        ...
                        $('#noted_by').val(null).trigger('change');
                        $('#conducted_by').val('');
                    }
                })
            });
            ...
            $(document).on('click', '.btn_edit', function () {
                ...
                $.ajax({
                    ...
                    success: function (e) {
                        ...
                        $('#edit_conducted_by').val(e['data']['conducted_by']);
                        ...
                        $('#edit_noted_by').empty().select2({
                            ...
                            allowClear: true,
                        }).val(e['data']['get_noted_by']['user_id']).trigger('change');
            ...
            $('#edit_pms_btn').click(function () {
                ...
                const edit_conducted_by = $('#edit_conducted_by').val();
                const edit_noted_by = $('#edit_noted_by').val();
            ...
            $('#noted_by').select2({
                dropdownParent: $('#add_pms_modal .modal-content'),
                ajax: {
                    url: '{{ route('get_noted_by') }}',
                    headers: {
                        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
